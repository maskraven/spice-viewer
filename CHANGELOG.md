...
## [1.0.1-beta] — 2026-07-17

### Changed

- **Dual pointer UX**: local host cursor stays visible while grabbed; translucent
  remote ghost follows the SPICE cursor channel (TeamViewer-style lag feedback).
- **Mouse mapping**: pad ↔ guest coordinates use the same contain letterboxing as
  the display image (fewer edge miss-clicks).
- **Open path / packaging / CI** fixes from the 1.0.0-beta cycle remain included
  in the single-commit tree (native file open, macOS AE open, Node 24 actions, etc.).
...
[Unreleased]: https://github.com/maskraven/spice-viewer/compare/v1.0.1-beta...HEAD
[1.0.1-beta]: https://github.com/maskraven/spice-viewer/releases/tag/v1.0.1-beta
[1.0.0-beta]: https://github.com/maskraven/spice-viewer/releases/tag/v1.0.0-beta
[0.1.0]: https://github.com/maskraven/spice-viewer/releases/tag/v0.1.0
