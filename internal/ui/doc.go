...
//   - Keyboard: Keyable guest pad holds focus while grabbed (avoids Fyne
//     dropping KeyDown when chrome Buttons are focused); KeyDown/Up → PC XT
//     scancodes; release-all on ungrab / pad FocusLost (multi-window safe)
